...
class Home extends CI_Controller 
{
	...
	public function absen()
	{
		...
		$tgl=date('Y-m-d');
		$jam=date('H:i:s');
		// date_add($jam, date_interval_create_from_date_string('-5 minutes'));
		// // echo date_format($jam, 'Y-m-d H:i:s');
		// // die;
		// $jam_klr=date_format($jam, 'H:i:s');
		// $jam_msk=date_format($jam, 'H:i:s');

		$jam_klr=date('H:i:s', strtotime('+5 minutes', strtotime($jam)));
		$jam_msk=date('H:i:s', strtotime('+5 minutes', strtotime($jam)));
		// $jam_set=11:00:00;
