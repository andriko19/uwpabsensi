...
<div class="main-content">
  <section class="section">
    ...
    <div class="card mb-4 mt-3">
      ...
      <div class="card-body">
        <a href="<?= base_url('admin/cetak_laporan/'. $tanggalAwal.'/'.$tanggalAkhir.'/'.$departemenn.'/'.$nama_karyawan);?>" target="blank" class="btn btn-dark mb-2" id="cetak" style="width: 95px;">Cetak PDF</a>
        <a href="<?= base_url('admin/cetak_excel/'. $tanggalAwal.'/'.$tanggalAkhir.'/'.$departemenn.'/'.$nama_karyawan);?>" class="btn btn-dark mb-2" style="width: 100px;">Cetak Excel</a>
