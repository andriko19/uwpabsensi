    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <?php echo form_open_multipart('admin/tambah_karyawan');?>
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control" name="nama_karyawan" id="nama_karyawan" value="<?= set_value('nama_karyawan');?>"> <?= form_error('nama_karyawan', '<b class="text-danger">', '</b>');?>
              </div>
            </div>
            <div class="form-group row mb-4">
